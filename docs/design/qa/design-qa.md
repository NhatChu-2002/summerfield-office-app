...
- Shared project ownership and persistence are still undecided. No project table or external integration was introduced in this slice. Actual-device touch testing and a hosted, post-migration assignee login remain open.
