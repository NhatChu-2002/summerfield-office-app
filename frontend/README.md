...
The connected MVP still covers tasks and team updates. The remaining prototype sections are UI-first previews until their shared services are integrated; this React app does not yet replace the existing reports, tickets, inventory, calendar, or department tools.
